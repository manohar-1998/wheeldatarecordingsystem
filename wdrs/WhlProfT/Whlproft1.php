...
$value2 = $_POST['q55_wheelSet'];
$value3 = $_POST['q5_wheelSet'];
$value4 = $_POST['q5_wheaasdelSet'];
$value5 = $_POST['ssSet'];
$value6 = $_POST['q5_wheaasdfelSet'];
$value7 = $_POST['q5_whefaasdfelSet'];
$value8 = $_POST['q9_input900'];
$value9 = $_POST['q9_input901'];
$value10 = $_POST['q9_input910'];
$value11 = $_POST['q9_input911'];
$value12 = $_POST['q12_hoausingF5ont'];
$value13 = $_POST['q12_housiangF5ont'];

$_POST['q12_housicangF5ont'] = ($_POST['q12_housicangF5ont'] == '//localhost/wel2/wdrs/UT/UT_of_WheelSet.php' ) ? 'OK' : 'NOT OK';
$value14 = $_POST['q12_housicangF5ont'];


$value15 = $_POST['q8_profileTurning'];
...
$sql = "INSERT INTO frm_wheelprofileturning VALUES ('$value1','$value2','$value3','$value4', '$value5','$value6','$value7','$value8','$value9','$value10', '$value11', '$value12','$value13','$value14','$value15')";                                            
//$_POST['q12_housicangF5ont'] = ($_POST['q12_housicangF5ont'] == 'OK' ) ? '$link = "<script>window.open(''//localhost/wel2/wdrs/UT/UT_of_WheelSet.php')<'/script>";'


//$link=$_POST['q12_housicangF5ont'];
//echo $link;
...
<body>
<form class="jotform-form" action="whlproft.php" method="post" name="form_81651655084460" id="81651655084460" accept-charset="utf-8">
  ...
  <li class="form-line form-line-column form-col-2" data-type="control_number" id="id_14">
        ...
        <label class="form-label form-label-left form-label-auto" id="labfel_16" for="input_16"> Reason For Rejection </label>
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_dropdown" id="id_8">
        ...
        <div id="cid_8" class="form-input-wide">
          <select onChange="getID(this.value);" class="form-dropdown" id="input_8" name="q8_profileTurning" style="width:150px" data-component="dropdown">
  ...
  <?php } ?>
        ...
        <div id="caid_20" class="form-input-wide">
          <select class="form-dropdown" id="inpaut_20" name="q20_insapectionBy" style="width:150px" data-component="dropdown">
      ...
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_button" id="id_22">
        <div id="cid_22" class="form-input-wide">
          <div style="margin-left:156px" class="form-buttons-wrapper">
            <button onchange="result();";  id="input_22" type="button" class="form-submit-button" data-component="button">
              Back
            </button>
          </div>
        </div>
...
$(document).ready(function(){
    $("#getFname").change(function(){
        var conceptName = $(".fwn  option:selected").val();
        if (conceptName === "NOT OK") {
        $("#input_16").focus();
      };
    });
});
    ...
    if (req) {
      ...
      req.onreadystatechange = function() {
        if (req.readyState == 4) {
          // only if "OK"
          if (req.status == 200) {            
            document.getElementById('caid_20').innerHTML=req.responseText;
