...
<form class="jotform-form" action="sub.php" method="post" name="form_81581246792464" id="81581246792464" accept-charset="utf-8">
  ...
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_dropdown" id="id_5">
        <label class="form-label form-label-top" id="label_5" for="input_5"> Current Employee Numbers </label>
        <div id="cid_5" class="form-input-wide">
          <select   class="form-dropdown" id="input_5" name="q5_selectThe" style="width:150px" data-component="dropdown">
  ...
  <?php } ?>
      ...
      <li class="form-line" data-type="control_text" id="id_6">
        <div id="cid_6" class="form-input-wide">
          <div id="text_6" class="form-html" data-component="text">
            <p style="text-align: center;"><strong>               Please enter the Employee details </strong></p>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_7">
        ...
        <input type="text" id="input_231" name="q23_d4iscHeat" data-type="input-textbox" class="form-textbox" size="20" value=""  data-component="textbox"  />
      ...
      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_8">
        ...
        <div id="cid_8" class="form-input-wide">
                         <input type="text" id="input_243" name="q23_dis1cHeat" data-type="input-textbox" class="form-textbox" size="20" value=""  data-component="textbox"  />
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_button" id="id_13">
        <div id="cid_13" class="form-input-wide">
          <div style="text-align:right" class="form-buttons-wrapper">
            <button name="submit" id="insert" type="submit" class="form-submit-button" data-component="button">
              Add new Employee
            </button>
          </div>
        </div>
